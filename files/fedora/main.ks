...
network --hostname=otan.hq.akdev.xyz
...
%post
echo rpm-ostree kargs --append=rd.driver.blacklist=nouveau --append=modprobe.blacklist=nouveau --append=nvidia-drm.modeset=1 > /var/log/akdev-post-inst.log
%end
